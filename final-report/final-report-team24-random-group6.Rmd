...
After the user selected bounds and weights, the user will be able to see the US map with shaded in different colors, as discussed in the methods section. 
...
The states light up green based on how well they match your selection. The goal of the project is to find the best state or states. Therefore, the more green, the more favorable the state.
