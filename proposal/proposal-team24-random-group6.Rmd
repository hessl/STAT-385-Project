...
- What steps must occur to complete the project before the end of the semester?
    + Webscraping: Extract data from multiple websites, specifically data related to the crime rate, school system, temperature, median home value, etc. Essentially,  factors that one might consider when considering the best county to live. 
